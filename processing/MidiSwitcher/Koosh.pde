...
class Line {
  ...
  public void move(){
    this.X = this.X + this.Xstep * map(parent.midi.speedDial, MidiStatus.DIAL_MIN, MidiStatus.DIAL_MAX, 0.01, 1);
    this.Y = this.Y + this.Ystep* map(parent.midi.speedDial, MidiStatus.DIAL_MIN, MidiStatus.DIAL_MAX, 0.01, 1);
  } //move
